...
public:
	...
	void ClearRenderTexture(float r, float g, float b) noexcept;
	void SwitchToBackBuffer() noexcept;
	void ShowTexture() noexcept;

	ID3D11ShaderResourceView* GetRenderTexture() const noexcept;
